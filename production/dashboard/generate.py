...
def render_html(reg: dict, stale: list[dict], commits: list[dict], branch: str) -> str:
    ...
    for ep_id, ep_title in EPISODES:
        ...
        for stage in STAGES:
            ...
            if path is None:
                ...
                cells.append(
                    f'<td class="cell {color}" title="{esc(tooltip)}">'
                    f'<a href="../../{esc(path)}" class="dot-link">'
    ...
    if awaiting:
        ...
        for a, st in awaiting:
            ...
            cards.append(
                f'<a class="card" href="../../{esc(a["path"])}">'
...
<body>
  ...
  <footer>
    <p>Generated by <code>python production/dashboard/generate.py</code>.
    Re-run after any edit to refresh.</p>
    <p>Source: <a href="../../docs/story.md">docs/story.md</a> ·
    <a href="../README.md">production/README.md</a> ·
    <a href="../DIRECTOR.md">production/DIRECTOR.md</a> ·
    <a href="../QUESTIONS.md">QUESTIONS.md</a> ·
    <a href="../REVIEW_QUEUE.md">REVIEW_QUEUE.md</a></p>
  </footer>
</body>
</html>
"""
